...
2. compiles pinned xterm.js assets into the Python package;
...
The log console uses xterm.js with Fit, Search, and WebLinks addons. Runtime assets are vendored and
